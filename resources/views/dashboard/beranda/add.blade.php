    ...
    <form action="/dashboard/beranda/add/simpan" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="text" name="txt_judul_beranda" class="form-control" id="exampleInputEmail1" placeholder="Masukan judul untuk beranda">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Deskripsi judul</label>
            <input type="text" name="txt_deskripsi_judul" class="form-control" id="exampleInputPassword1" placeholder="Masukan deskripsi judul untuk beranda">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <div class="custom-file">
                <input type="file" name="txt_file_gambar_beranda" class="custom-file-input" id="exampleInputFile">
